...
#ifndef TTT_MSGS__MSG__DETAIL__GAME_STATE__TYPE_SUPPORT_H_
#define TTT_MSGS__MSG__DETAIL__GAME_STATE__TYPE_SUPPORT_H_
...
#endif  // TTT_MSGS__MSG__DETAIL__GAME_STATE__TYPE_SUPPORT_H_
