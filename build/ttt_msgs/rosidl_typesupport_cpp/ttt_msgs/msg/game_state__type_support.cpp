...
static const _GameState_type_support_symbol_names_t _GameState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ttt_msgs, msg, GameState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ttt_msgs, msg, GameState)),
  }
};
...
{
  return &::ttt_msgs::msg::rosidl_typesupport_cpp::GameState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ttt_msgs, msg, GameState)() {
  return get_message_type_support_handle<ttt_msgs::msg::GameState>();
}
