...
#include "ttt_msgs/msg/detail/game_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ttt_msgs::msg::GameState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ttt_msgs::msg::GameState & ros_message)
{
  // Member: cells
  {
    cdr >> ros_message.cells;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ttt_msgs::msg::GameState;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ttt_msgs
max_serialized_size_key_GameState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const ttt_msgs::msg::GameState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ttt_msgs::msg::GameState *>(
    untyped_ros_message);
...
{
  return &ttt_msgs::msg::typesupport_fastrtps_cpp::_GameState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ttt_msgs, msg, GameState)() {
  return &ttt_msgs::msg::typesupport_fastrtps_cpp::_GameState__handle;
}
